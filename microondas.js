...
var alimento = {Pipoca: 10, Macarrao: 8, Carne: 15, Feijao: 12, Brigadeiro: 8};


var nome = function (alimento) {
    if (alimento =="Pipoca" || alimento == 'Macarrao' || alimento == 'Carne' || alimento == 'Feijao' || alimento =='Brigadeiro'){
        return `Preparando ${alimento}`
    }
    else {
...
var incremento = function (n1) { 
    ...
    if (n1<escolha){
        return "O tempo informado é menor que o padrão!"
    }
    if (escolha*3<n1){
        return "Kabumm"
    }
